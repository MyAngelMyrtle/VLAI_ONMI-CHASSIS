...
//	    DataScope_Get_Channel_Data(yaw_agl.Out);
//			DataScope_Get_Channel_Data(yaw_agl.slope);
//			DataScope_Get_Channel_Data(pid_yaw_angle_6020.iout);
//      DataScope_Get_Channel_Data(gimbal.pid.yaw_angle_gimbal_ref);
//      DataScope_Get_Channel_Data(gimbal.pid.yaw_angle_gimbal_fdb);
//		 DataScope_Get_Channel_Data(gimbal.pid.yaw_spd_gimbal_ref);
//      DataScope_Get_Channel_Data(gimbal.pid.yaw_spd_gimbal_fdb);
